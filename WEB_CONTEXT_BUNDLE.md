...
```json
{
  ...
  "attempts": [
    {
      "artifacts": [],
      "attempt_id": "attempt:um-green-005-product-free-sets-in-finite-groups-5ee8bb46-source-fidelity-01",
      "claims": [],
      "completed_at": null,
      "generator": "trusted-rolling-source-admission-v1",
      "inputs": [
        "problem-library/records/canonical-problems.jsonl",
        "https://www.unsolvedmath.com/problems/GREEN-005"
      ],
      "lifecycle": "planned",
      "method": "discovery",
      "objective": "Close the source-fidelity obligation before attempting the frozen root statement.",
      "obligation_graph_id": "graph:um-green-005-product-free-sets-in-finite-groups-5ee8bb46-v1",
      "problem_contract_sha256": "58a20752729009e5e60e6e447e85a7a0d3b0ec983e6d0857947d3b44d07f5ce2",
      "problem_id": "problem:um-green-005-product-free-sets-in-finite-groups-5ee8bb46",
      "route_id": "route:um-green-005-product-free-sets-in-finite-groups-5ee8bb46-source-fidelity",
  ...
  "obligation_graphs": [
    {
      "attempt_id": "attempt:um-green-005-product-free-sets-in-finite-groups-5ee8bb46-source-fidelity-01",
      "graph_id": "graph:um-green-005-product-free-sets-in-finite-groups-5ee8bb46-v1",
      "obligations": [
        {
          "dependencies": [
            "obligation:um-green-005-product-free-sets-in-finite-groups-5ee8bb46-statement-fidelity"
          ],
          "kind": "root_claim",
          "obligation_id": "obligation:um-green-005-product-free-sets-in-finite-groups-5ee8bb46-root",
          "statement": {
            "formal_declaration": null,
            "language": "en",
            "text": "Which finite groups have the smallest largest product-free sets?"
          },
          "statement_sha256": "e64c89f996abfba0fde1ea00e4b03b7f1cd7f68c1d567974dc5d06ceace4e1ae"
        },
        {
          "dependencies": [],
          "kind": "definition",
          "obligation_id": "obligation:um-green-005-product-free-sets-in-finite-groups-5ee8bb46-statement-fidelity",
          "statement": {
            "formal_declaration": null,
            "language": "en",
      ...
      "root_obligation_id": "obligation:um-green-005-product-free-sets-in-finite-groups-5ee8bb46-root",
      "route_id": "route:um-green-005-product-free-sets-in-finite-groups-5ee8bb46-source-fidelity"
    }
  ],
  "problem_contract": {
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-green-005-e520ed8b13b7",
        "url": "https://www.unsolvedmath.com/problems/GREEN-005"
      },
      {
        "retrieved_at": "2026-09-02T00:06:43Z",
